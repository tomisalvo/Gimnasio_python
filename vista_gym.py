...
class Principal():
    ...
    def formulario_principal(self):
        ...
        photo= PhotoImage(file="C:\\Users\\PC\\Desktop\\logo.gif") 

        ### LABELS ####
        self.label_imagen = Label(self.root, image=photo)
        self.label_imagen.image = photo   # mantener referencia para que no se borre
        self.label_imagen.grid(row=0, column=0, columnspan=3)
